...
.PHONY: component-loki-apply
component-loki-apply: ${BINARY_HELM} check-k8s-namespace-env-var ${K8S_HELM_RESSOURCES}/charts helm-loki-chart-import component-generate $(K8S_POST_GENERATE_TARGETS) ## Applies the component yaml resource to the actual defined context.
